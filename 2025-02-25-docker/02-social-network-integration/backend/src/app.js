...
(async () => {
    ...
    app.use(auth_middleware_1.extractUserFromToken);
    // public routes (no auth required)
    app.use('/auth', auth_1.default); // Login/signup don't need authentication
    // protected routes - apply requireAuth
    app.use('/profile', auth_middleware_1.requireAuth, profile_1.default);
    app.use('/follows', auth_middleware_1.requireAuth, follows_1.default);
    app.use('/comments', auth_middleware_1.requireAuth, comments_1.default);
    app.use('/feed', auth_middleware_1.requireAuth, feed_1.default);
